...
/***************************** #1 Snake10v2 ***********************************\
| a 10 pixel snake writhing within the 4x4x4 cube - colour cycles in between   |
| all colours                                                                  |
|                                                                              |
...
while (continuePattern) {
  for (int y = 0; y < 100; y++) {
    ...
    switch(random(0,6)) {
      case 0:
        if (xpos[0] > 0) {xpos[0]--;break;}
      case 1:
        if (xpos[0] < 3) {xpos[0]++;break;}
        xpos[0]--; break;
      case 2:
        if (ypos[0] > 0) {ypos[0]--;break;}
      case 3:
        if (ypos[0] < 3) {ypos[0]++;break;}
        ypos[0]--; break;
      case 4:
        if (zpos[0] > 0) {zpos[0]--;break;}
      case 5:
        if (zpos[0] < 3) {zpos[0]++;break;}
        zpos[0]--; break;
      }
      flushBuffer();
      clearBuffer();
